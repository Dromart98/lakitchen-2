...
export type VoiceInventoryBatchResult =
 ...
 | { status: "error"; code: "invalid-input" | "too-many-products" | "not-configured" | "ai-burst-limit" | "daily-ai-limit" | "ai-access-unavailable" | "ai-feature-disabled" | "timeout" | "rate-limited" | "provider-error" | "invalid-ai-response"; message: string };
