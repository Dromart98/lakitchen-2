...
export type PhotoMealErrorCode = "invalid-photo" | "unsupported-photo" | "photo-too-large" | "photo-processing-failed" | "unauthenticated" | "missing-api-key" | "ai-burst-limit" | "daily-ai-limit" | "ai-access-unavailable" | "ai-feature-disabled" | "provider-timeout" | "provider-error" | "invalid-ai-response" | "unexpected-error";
