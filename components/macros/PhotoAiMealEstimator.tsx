...
const errors: Record<string, string> = { "invalid-photo": "La fotografía no es válida.", "unsupported-photo": "Envía una fotografía JPEG, PNG o WebP.", "photo-too-large": "La fotografía preparada supera 5 MB.", "photo-processing-failed": "No se pudo preparar la fotografía. Elige otra.", unauthenticated: "Tu sesión ha caducado.", "missing-api-key": "El análisis no está disponible ahora.", "daily-ai-cost-limit": "Has alcanzado el límite diario de funciones con IA. Podrás volver a usarlas mañana.",
  "daily-ai-limit": "Has alcanzado el límite de funciones con IA de hoy. Podrás volver a usarlas mañana.", "ai-access-unavailable": "Las funciones con IA no están disponibles ahora. Inténtalo más tarde.", "ai-feature-disabled": "Esta función no está disponible.", "provider-timeout": "El análisis tardó demasiado.", "provider-error": "No se pudo analizar la fotografía.", "invalid-ai-response": "No se pudo validar la estimación.", "unexpected-error": "Ocurrió un error inesperado." };
