...
const inventory: DailyPlanInventoryItem[] = [
  { id: "oats", name: "Avena", quantity: 500, unit: "g", expires_at: "2026-07-30", category: "carb", nutrition_basis: "per_100g", calories: 380, protein_g: 13, carbs_g: 60, fat_g: 7 },
  ...
  { id: "rice", name: "Arroz", quantity: 300, unit: "g", expires_at: null, category: "carb", nutrition_basis: "per_100g", calories: 350, protein_g: 7, carbs_g: 78, fat_g: 1 },
...
describe("daily plan AI", () => {
  it("accepts exactly the public request fields", () => {
    const parsed = buildDailyPlanTarget({ target_calories: 2000, target_protein_g: 120, target_carbs_g: 220, target_fat_g: 60 });
    expect(parsed).toEqual({ calories: 2000, protein_g: 120, carbs_g: 220, fat_g: 60 });
