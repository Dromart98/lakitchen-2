-- Allow reviewed voice inventory items to be saved without a nutritional category.
...
begin
  ...
  select v_user_id, btrim(value->>'name'), (value->>'quantity')::numeric, value->>'unit', value->>'location', nullif(value->>'category', ''), value->>'nutrition_basis', (value->>'calories')::numeric, (value->>'protein_g')::numeric, (value->>'carbs_g')::numeric, (value->>'fat_g')::numeric, null
