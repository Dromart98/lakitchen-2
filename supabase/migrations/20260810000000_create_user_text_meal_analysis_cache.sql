create table public.user_text_meal_analysis_cache (
  ...
  constraint user_text_meal_cache_user_key unique (user_id, cache_key),
...
revoke all on table public.user_text_meal_analysis_cache from public;
revoke all on table public.user_text_meal_analysis_cache from anon;
revoke all on table public.user_text_meal_analysis_cache from authenticated;
grant select, insert, update, delete on table public.user_text_meal_analysis_cache to service_role;
