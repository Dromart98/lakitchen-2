        ...
        <div className="macros-lower-grid">
          <section className="card macros-add" aria-labelledby="macros-add-title">
            ...
            <form action={addMealLogAction} className="meal-log-form macros-meal-form">
              ...
              <label className="field" htmlFor="macros-calories"><span>Calorías</span><input id="macros-calories" name="calories" type="number" min="0" step="1" required defaultValue="0" /></label>
              <label className="field" htmlFor="macros-protein"><span>Proteína (g)</span><input id="macros-protein" name="protein_g" type="number" min="0" step="1" required defaultValue="0" /></label>
              <label className="field" htmlFor="macros-carbs"><span>Carbohidratos (g)</span><input id="macros-carbs" name="carbs_g" type="number" min="0" step="1" required defaultValue="0" /></label>
              <label className="field" htmlFor="macros-fat"><span>Grasas (g)</span><input id="macros-fat" name="fat_g" type="number" min="0" step="1" required defaultValue="0" /></label>
